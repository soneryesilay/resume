  ...
  return (
    <div
      ...
      className={cn(
        ...
        orientation === "horizontal" ? "sm:basis-1/2 md:basis-1/3 lg:basis-1/4" : "pt-4",
        className
      )}
      {...props}
    />
